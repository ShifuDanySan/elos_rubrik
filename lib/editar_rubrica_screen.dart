        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text("1. CRITERIOS DE EVALUACIÓN: son las categorías principales (competencias). El 'Peso' define su importancia total (debe sumar 1.0)."),
              const Text("2. DESCRIPTORES: son los niveles de logro/calidad (ej. 'Excelente', 'Regular') obtenidos por el estudiante en relación a dicha competencia."),
              const Text("3. CRITERIOS ANALÍTICOS: son los puntos específicos a medir (variables a analizar) que componen cada descriptor. El 'Grado' es el valor de logro (0.0 a 1.0)."),
              const Text("4. OPERADORES: si un descriptor se compone de más de un criterio analítico, el operador actua como nexo lógico entre ellos, y determina su condición de análisis\n- AND: Exige que se cumplan (en cierto grado) ambas condiciones, determinadas por cada criterio analítico.\n- OR: Basta con que se cumpla una de las dos condiciones para dar por verdadera (en cierto grado) la afirmación."),
              const Divider(height: 30),
              const Text("EJEMPLO (Cátedra de Programación):", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              const Text("• Criterio de Evaluación: 'Calidad de Código' (Peso 0.60)."),
              const Text("• Nivel de logro (descriptor): 'Excelente' (Peso 1.0)."),
              const Text("• Analítico: 'Uso adecuado de variables' (Grado 1.0) AND 'Comentarios acertados' (Grado 0.8)."),
              const Text("-> El sistema verificará que el estudiante cumpla con el 'uso adecuado de variables' y (AND) los 'comentarios acertados' para vislumbrar su nivel de logro obtenido, en cuanto a esta determinada competencia (nivel de excelencia en cuanto a la calidad del código)."),
            ],
          ),
        ),
